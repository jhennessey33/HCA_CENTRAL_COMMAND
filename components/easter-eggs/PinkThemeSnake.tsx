    ...
    <div className="mt-auto pt-4">
      <div className="rounded-2xl border border-pink-200 bg-white/95 p-3 shadow-sm backdrop-blur">
        ...
        <div
          ...
          className="grid aspect-square w-full grid-cols-12 overflow-hidden rounded-xl border border-slate-700 bg-slate-950 outline-none ring-pink-400 focus:ring-2"
        >
          {Array.from({
